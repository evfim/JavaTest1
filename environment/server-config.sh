...
mkdir -p -m a=rwx /home/vagrant/crmmvc >/dev/null 2>&1
git clone https://github.com/lamyongxian/crmmvc.git /home/vagrant/crmmvc >/dev/null 2>&1
pwd
...
cd /home/vagrant/crmmvc && pwd
sudo docker-compose -f /home/vagrant/crmmvc/docker-compose.yml up --build -d
