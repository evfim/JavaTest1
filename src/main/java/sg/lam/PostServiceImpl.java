...
public class PostServiceImpl implements PostService {
	...
	public Post createOrEdit(int id, String title, String content, String imagePath, Date publishTo, Status status,
			PostOwner owner) {
	...
	public Post createOrEdit(int id, String title, String content) {
		return this.createOrEdit(id, title, content, null, null, Status.draft, null);
	}
